...
- [x] Add first dashboard navigation layer: All providers view, provider-specific detail pages, provider setup moved out of Settings, starred providers sorted to the top, and starred providers feeding the glance window with existing defaults as fallback.
